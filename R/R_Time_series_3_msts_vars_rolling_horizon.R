...
#Solar_Output_and_Power_Consumption.csv
...
WFdemand_msts <- msts (WFdata$Electricity.Demand.for.the.Branch..kw., seasonal.periods=c(96,672)) #define multiple-seasonality time series (time of day (15mins) and day of week)
...
WFdemand_tbats_pred <- forecast(WFdemand_tbats, h=1344, level=c(0.8, 0.95)) #predict 2 weeks out
