...
#read data
setwd("/Users/mm679j/Documents/R/churn_mma831/")
...
#The [TENURE] futime column holds the survival times. This is the response variabl
...
surv_object = Surv(time = churn$tenure, event = churn$censor_flag)
...
#Now what, is there a more systematic way to look at the different covariates?
